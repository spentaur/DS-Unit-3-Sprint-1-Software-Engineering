...
- The most important part of code review is making sure the code is readability.
  I think it's easy for us to get lost in our own code. We don't notice poor naming
  conventions, smells, lack of comments because in the moment we can justify it to
  ourselves. "I know what that means" doesn't mean that someone else will. Our code
  could be read by potentially thousands of other people, and if it's not clean and
  logical and concise, bugs can be missed, efficiency lost, time wasted, all things
  that makes for a bad work environment.

- The cool thing about containers is they're all the same. It's like if we took all
  your computers and started from scratch, got rid of all the stuff that's been
  downloaded over the years, and then ensured that they all had the same software
  and versions of that software. This also means that if you want more computers,
  we can put them in and you'd never know it hadn't always been there.
